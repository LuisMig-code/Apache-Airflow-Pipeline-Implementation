...
dag = DAG(
    "windturbine",
    description= "Trabalho final - Dados da turbina",
    schedule_interval=None,
    start_date=datetime(2023,3,5),
    catchup=False,
    default_args=default_args,
    default_view="graph",
    doc_md="## DAG para registrar dados de turbina eolica" #Criar uma documentacao usando docdown
)
...
create_table_task = PostgresOperator(
    ...
    sql='''
    CREATE TABLE IF NOT EXISTS sensors(idtemp varchar, powerfactor varchar 
...
send_email_alert = EmailOperator(
    ...
    to="meireles2013miguel@gmail.com",
...
file_sensor_task >> get_data >> group_check_temp
